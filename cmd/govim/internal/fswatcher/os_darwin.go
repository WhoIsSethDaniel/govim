...
func New(gomodpath string, tomb *tomb.Tomb) (FSWatcher, error) {
	...
	return FSWatcher(&watcher{eventCh, es}), nil
}

func (w *watcher) Add(path string) error    { return nil }
func (w *watcher) Remove(path string) error { return nil }
func (w *watcher) Close() error {
	w.es.Stop()
	return nil
}
func (w *watcher) Events() chan Event { return w.eventCh }
func (w *watcher) Errors() chan error { return make(chan error) }
